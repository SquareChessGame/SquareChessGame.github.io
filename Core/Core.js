...
function Opt(){Id("Setting").style.height=($(window).height()-40)+"px";var id=Dft.Oln.Id
	...
	if(MdQ.indexOf("Connect")>-1||MdQ.indexOf("Divider")>-1||MdQ.indexOf("Adapter")>-1||MdQ.indexOf("Enhance")>-1||MdQ.indexOf("Kingdom")>-1)OpS("System-Lmt","k","首回限制",Dft.System.Lmt)
	OpS("System-iTn","k","上回設置",Dft.System.iTn)
	if(MdQ.indexOf("Connect")>-1||MdQ.indexOf("Divider")>-1||MdQ.indexOf("Adapter")>-1||MdQ.indexOf("Enhance")>-1)OpS("System-Nxt","k","次回設置",Dft.System.Nxt)
